...
function Hero({setActive}){return(<section style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"100px 24px 60px",position:"relative"}}>
  {/* هنا تم استرجاع اسم الصورة الأصلي hero-banner.jpg */}
  ...
  {/* هنا تم استرجاع اسم الصورة الأصلي coach-profile.webp */}
...
function GoIntel({setActive}){
  // === هنا تم استرجاع الأسماء الأصلية للملفات ===
  const forexMarkets=[
...
function GoOS({setActive}){
  ...
  // === استرجاع أسماء الصور الطويلة الأصلية ===
  const features=[
    {icon:"🧠",title:"ذكاء تداول شخصي",image:"/images/goos-personal-intel.jpg",desc:"كل تجربة مخصصة — يتكيّف GO OS حسب أهدافك الشخصية."},
    {icon:"📡",title:"إشارات مبنية على الذكاء",image:"/images/goos-signals.jpg",desc:"الإشارات تُولّد من نماذج ذكاء حية وليس قواعد ثابتة."},
    {icon:"⚙️",title:"محرك الاستراتيجيات",image:"/images/goos-strategy-engine.jpg",desc:"منطق استراتيجي متقدم يعمل تحت الواجهة."},
    {icon:"📸",title:"تحليل الشارت بالصور",image:"/images/goos-chart-analysis.jpg",desc:"ارفع صورة شارت أو لقطة شاشة — GO OS يحللها."},
    {icon:"📊",title:"تتبع الأداء الحي",image:"/images/goos-performance.jpg",desc:"يتتبع كل إشارة وتفاعل — نسب الربح/الخسارة."},
    {icon:"📰",title:"أخبار وبيانات فورية",image:"/images/goos-news.jpg",desc:"GO OS يدمج الأخبار الماكروية والسوقية الفورية."},
    {icon:"🌍",title:"تواصل متعدد اللغات",image:"/images/goos-multilingual.jpg",desc:"GO OS يتواصل بطلاقة عبر لغات متعددة."},
  ];
  return(
    <section style={{padding:"80px 24px",maxWidth:1200,margin:"0 auto"}}>
...
function GoLibrary({setActive}){
  // === استرجاع أسماء الصور الأصلية ===
  const levels=[
    {title:"أساسيات السوق",titleEn:"Market Foundation",desc:"تعلّم كيف يعمل سوق الفوركس فعلاً.",image:"/images/lib-market-foundation.jpg",items:["ما هو التداول؟","مقدمة سريعة عن عالم التداول وكيف تبدأ رحلتك"]},
    {title:"الأساسيات التطبيقية",titleEn:"Applied Foundation",desc:"خذ المفاهيم الأساسية وطبّقها في ظروف السوق الحقيقية.",image:"/images/lib-applied-foundation.jpg",items:["أساسيات الفوركس — تعلّم أساسيات تداول الفوركس","أساسيات الأسهم — تعلّم أساسيات الأسهم","أساسيات الكريبتو — تعلّم أساسيات العملات الرقمية"]},
    {title:"الأساسيات المتقدمة",titleEn:"Advanced Foundation",desc:"أتقن هيكل السوق المتقدم والسيولة والتنفيذ الدقيق.",image:"/images/lib-advanced-foundation.jpg",items:["هيكل السوق — تعلّم أساسيات هيكل السوق وتحليله"]},
  ];
  return(
    <section style={{padding:"80px 24px",maxWidth:1200,margin:"0 auto"}}>
...
function SuccessStories({setActive}){
  // === هنا تم استرجاع الأسماء الأصلية للفيديوهات ===
  const stories=[
